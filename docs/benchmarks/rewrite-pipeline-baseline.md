...
| Transform              | `convert msg geo`                                                   | process non-trivial (decode/transform) | **Pipelined** 3-stage; consider decode workers only if process grows | Emission-order only; **no** content reorder |
