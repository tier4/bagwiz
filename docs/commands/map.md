...
| `--cam-info <image>=<info>...` | Explicit `sensor_msgs/msg/CameraInfo` topic per camera, as `<image_topic>=<info_topic>` pairs (requires `--color`; several after one flag and/or repeated). Cameras without an entry auto-resolve their `CameraInfo` from the image topic name using the standard suffix rules. An entry whose `<image_topic>` is not a listed camera topic, a malformed entry, and a duplicate `<image_topic>` are errors.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
