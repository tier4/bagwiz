...
#ifndef BAGWIZ__CORE__SLAM__VISUAL_ODOMETRY_WINDOW_HPP_
#define BAGWIZ__CORE__SLAM__VISUAL_ODOMETRY_WINDOW_HPP_
...
#endif  // BAGWIZ__CORE__SLAM__VISUAL_ODOMETRY_WINDOW_HPP_
