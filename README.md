...
| [`bagwiz cam-info`](docs/commands/cam-info.md) | Replace (`replace`) one or more CameraInfo topics' calibration with values from a camera_calibration YAML file, or recompute (`recompute-p`) the projection matrix from the intrinsics.       |
