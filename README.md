...
| [`bagwiz tf`](docs/commands/tf.md)             | Inspect and edit TF in a ROS 2 rosbag: frame tree, static-transform resolution, static-TF copy, and dumping the static tree to a publisher-config YAML.                                                                                                                                                       |
