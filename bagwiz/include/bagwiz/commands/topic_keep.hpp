...
#ifndef BAGWIZ__COMMANDS__TOPIC_KEEP_HPP_
#define BAGWIZ__COMMANDS__TOPIC_KEEP_HPP_
...
// Keep only the topics matched by any of `args.topics`, dropping every other
// topic from `args.input_path` (a dropped topic disappears entirely — neither
// declared nor carrying any message). Returns a process exit code: 0 on success,
...
#endif  // BAGWIZ__COMMANDS__TOPIC_KEEP_HPP_
